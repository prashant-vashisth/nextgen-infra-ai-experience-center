...
const USE_CASES = [
  ...
  { id: 4,  domain: 'Automation Engineering', title: 'Code Base Administration',                             category: 'AI Bug Fixes',             problem: 'Bug triage and patching creates developer context-switching overhead',         tools: ['GitHub','SonarQube','Claude Opus 4'],                               live: false },
  ...
  { id: 9,  domain: 'Automation Engineering', title: 'APG Workflow Assist Agent',                            category: 'Guided Explainability',    problem: 'Terraform pipeline failures generate cryptic errors requiring expert analysis', tools: ['GitHub Actions','APG Engine','ServiceNow KB','Claude Opus 4'],      live: true,  path: '/demo/apg-agent' },
  ...
  { id: 13, domain: 'Automation Engineering', title: 'AI-Driven Dependency Risk Management',                 category: 'Risk Management',          problem: 'Outdated dependencies with known CVEs accumulate undetected',                 tools: ['Snyk','GitHub','Claude Opus 4'],                                    live: true,  path: '/demo/dependency-risk-agent' },
  ...
  { id: 17, domain: 'Infra Ops / ESC',        title: 'Design Document Generation',                           category: 'Documentation AI',         problem: 'Architecture docs are outdated within weeks, never reflect real state',       tools: ['Confluence','GitHub','Claude Opus 4'],                              live: false },
  ...
  { id: 35, domain: 'Security Engineering',   title: 'Cost Anomaly Detection, Budget Forecasting',           category: 'FinOps',                   problem: 'Cost spikes discovered well after occurrence — no real-time alerting',        tools: ['Azure Cost Management','Power BI','Claude Opus 4'],                live: true,  path: '/demo/finops-cost-agent' },
  ...
  { id: 41, domain: 'Infra Ops / ESC',        title: 'AI RCA + CMDB Data Cleanup & Enrichment',              category: 'CMDB Health',              problem: 'CMDB health degraded — CIs with missing attributes impacting ITSM quality',  tools: ['ServiceNow CMDB','Dynatrace','Claude Opus 4'],                      live: true,  path: '/demo/rca-cmdb-agent' },
  { id: 42, domain: 'Infra Ops / ESC',        title: 'Knowledge Fabric AI',                                  category: 'Knowledge Management',     problem: 'KB articles outdated; engineers waste time per incident searching',           tools: ['ServiceNow KB','Confluence','Claude Opus 4'],                      live: false },
  ...
  { id: 44, domain: 'Infra Ops / ESC',        title: 'PCT Automation — RCA Agent & Health Check Agent',      category: 'PCT Automation',           problem: 'Post-change testing requires extended manual health check window',            tools: ['Dynatrace','ServiceNow','Claude Opus 4'],                           live: false },
  { id: 45, domain: 'Infra Ops / ESC',        title: 'PCT Automation — Root Cause Analysis Agent',           category: 'PCT Automation',           problem: 'PCT RCA takes hours without AI-assisted correlation of signals',              tools: ['Splunk','Dynatrace','ServiceNow','Claude Opus 4'],                  live: false },

  // CVIT
  { id: 36.1, domain: 'Security Engineering', title: 'CVIT Multi-Agent Orchestrator',                        category: 'Vulnerability Management', problem: '10-step agentic CVIT remediation: detect, enrich, approve, patch, validate',  tools: ['LangGraph','Claude Opus 4','ServiceNow','GitHub','Azure AKS'],      live: true,  path: '/demo/cvit-workflow' },
]
